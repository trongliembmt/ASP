...
try
{
    ...
    {
        var dbContext = scope.ServiceProvider.GetRequiredService<TeduBlogContext>();
        Console.WriteLine("✅ DbContext created successfully");

        if (dbContext.Database.CanConnect())
        {
            Console.WriteLine("✅ Database connection successful!");
            Console.WriteLine($"✅ Database: TeduBlog");
        }
        else
        {
...
Console.WriteLine("=== End Connection Test ===\n");
...
catch (Exception ex)
{
    ...
    Console.WriteLine("App will continue running without database migrations.");
}
